...
def run(params:dict,model=None):
    ...
    if params['back']=='lws':
        ...
        return {"scores":{"acc":defense_val_attack_acc,"asr":defense_val_attack2_acc,"robust":defense_robust_test_acc},"total_scores":total*100}
    ...
    if params['back']=='hiddenkiller':
        ...
        return {"scores":{"acc":clean_acc,"asr":poison_success_rate_test,"robust":robust_acc},"total_scores":total*100}
        return clean_acc,1-poison_success_rate_test,robust_acc,total